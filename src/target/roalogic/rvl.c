...
static const struct rvl_core_reg_init rcl_init_reg_list[] = {
	{"x0",        GROUP_INT_RF + 0, "org.gnu.gdb.rvl.group0", NULL},
	{"ra",        GROUP_INT_RF + 1, "org.gnu.gdb.rvl.group0", NULL},
	{"sp",        GROUP_INT_RF + 2, "org.gnu.gdb.rvl.group0", NULL},
	{"gp",        GROUP_INT_RF + 3, "org.gnu.gdb.rvl.group0", NULL},
	{"tp",        GROUP_INT_RF + 4, "org.gnu.gdb.rvl.group0", NULL},
	{"t0",        GROUP_INT_RF + 5, "org.gnu.gdb.rvl.group0", NULL},
	{"t1",        GROUP_INT_RF + 6, "org.gnu.gdb.rvl.group0", NULL},
	{"t2",        GROUP_INT_RF + 7, "org.gnu.gdb.rvl.group0", NULL},
	{"s0",        GROUP_INT_RF + 8, "org.gnu.gdb.rvl.group0", NULL},
	{"s1",        GROUP_INT_RF + 9, "org.gnu.gdb.rvl.group0", NULL},
	{"a0",        GROUP_INT_RF +10, "org.gnu.gdb.rvl.group0", NULL},
	{"a1",        GROUP_INT_RF +11, "org.gnu.gdb.rvl.group0", NULL},
	{"a2",        GROUP_INT_RF +12, "org.gnu.gdb.rvl.group0", NULL},
	{"a3",        GROUP_INT_RF +13, "org.gnu.gdb.rvl.group0", NULL},
	{"a4",        GROUP_INT_RF +14, "org.gnu.gdb.rvl.group0", NULL},
	{"a5",        GROUP_INT_RF +15, "org.gnu.gdb.rvl.group0", NULL},
	{"a6",        GROUP_INT_RF +16, "org.gnu.gdb.rvl.group0", NULL},
	{"a7",        GROUP_INT_RF +17, "org.gnu.gdb.rvl.group0", NULL},
	{"s2",        GROUP_INT_RF +18, "org.gnu.gdb.rvl.group0", NULL},
	{"s3",        GROUP_INT_RF +19, "org.gnu.gdb.rvl.group0", NULL},
	{"s4",        GROUP_INT_RF +20, "org.gnu.gdb.rvl.group0", NULL},
	{"s5",        GROUP_INT_RF +21, "org.gnu.gdb.rvl.group0", NULL},
	{"s6",        GROUP_INT_RF +22, "org.gnu.gdb.rvl.group0", NULL},
	{"s7",        GROUP_INT_RF +23, "org.gnu.gdb.rvl.group0", NULL},
	{"s8",        GROUP_INT_RF +24, "org.gnu.gdb.rvl.group0", NULL},
	{"s9",        GROUP_INT_RF +25, "org.gnu.gdb.rvl.group0", NULL},
	{"s10",       GROUP_INT_RF +26, "org.gnu.gdb.rvl.group0", NULL},
	{"s11",       GROUP_INT_RF +27, "org.gnu.gdb.rvl.group0", NULL},
	{"t3",        GROUP_INT_RF +28, "org.gnu.gdb.rvl.group0", NULL},
	{"t4",        GROUP_INT_RF +29, "org.gnu.gdb.rvl.group0", NULL},
	{"t5",        GROUP_INT_RF +30, "org.gnu.gdb.rvl.group0", NULL},
	{"t6",        GROUP_INT_RF +31, "org.gnu.gdb.rvl.group0", NULL},
			       ...
			       struct breakpoint *breakpoint)
{
	...
	target_buffer_set_u32(target, or1k_trap_insn, RV_EBREAK_INSTR);
